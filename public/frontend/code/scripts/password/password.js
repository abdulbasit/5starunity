...
// Source: src/i18n.js
    ...
    (function (i18n, i18next) {
        ...
        i18n.fallback = {
            "wordMinLength": "Your password is too short. (minim 6 characters)",
            "wordMaxLength": "Your password is too long",
            "wordInvalidChar": "Your password contains an invalid character",
            "wordNotEmail": "Do not use your email as your password",
            "wordSimilarToUsername": "Your password cannot contain your username",
            "wordTwoCharacterClasses": "Use at least 2 different character classes",
            "wordRepetitions": "Too many repetitions",
            "wordSequences": "Your password contains sequences",
            "errorList": "Errors:",
            "veryWeak": "<div style='width:200px;'>Very Weak <br /><span style='font-size:24px;color:#20A08E;'>☆☆☆☆☆</span></div>",
            "weak": "<div style='width:200px;'>Weak <br /><span style='font-size:24px;color:#20A08E;'>★☆☆☆☆</span></div>",
            "normal": "<div style='width:200px;'>Normal <br /><span style='font-size:24px;color:#20A08E;'>★★☆☆☆</span></div>",
            "medium": "<div style='width:200px;'>Medium <br /><span style='font-size:24px;color:#20A08E;'>★★★☆☆</span></div>",
            "strong": "<div style='width:200px;'>Strong <br /><span style='font-size:24px;color:#20A08E;'>★★★★☆</span></div>",
            "veryStrong": "<div style='width:200px;'>Very Strong <br /><span style='font-size:24px;color:#20A08E;'>★★★★★</span></div>"
        };
...
// Source: src/options.js
    ...
    defaultOptions.common.maxChar = 30;
    ...
    defaultOptions.ui.popoverPlacement = "right";
...
// Source: src/methods.js
    ...
    (function ($, methods) {
        ...
        onKeyUp = function (event) {
            ...
            if ($.isFunction(options.common.onKeyUp)) {
                options.common.onKeyUp(event, {
                    ...
                    errors: options.instances.errors
                });
            }
        };
        ...
        methods.updateOptions = function (key, value) {
            this.each(function (idx, el) {
                var options = $(el).data("pwstrength-bootstrap");
                options.ui[key] = value;
        ...
        methods.getErrors = function(data) {
            this.each(function (idx, el) {
                var options = $(el).data("pwstrength-bootstrap");
                data.errors = options.instances.errors.length;
            });
        };
