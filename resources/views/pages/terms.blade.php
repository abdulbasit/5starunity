                                ...
                                <div class="col-md-2">
                                    ...
                                    @if($key==0)
                                        <div style="height:180px; border-left:solid 1px #ccc; position:relative; top:-2px; padding-top:30px; text-align:center; font-weight:bold; font-size:14px; padding-top:10px">
                                            ...
                                            <a style="position:relative; left:10px; top:70px; background-color:green; color:white; text-decoration:none; " href="{{$promotions->reference_website}}" class="btn-green">Click Here </a>
                                        </div>
                                    @else
