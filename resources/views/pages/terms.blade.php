        ...
        <div class="row">
            <div class="col-xs-12 terms_cond" id="terms">
                    ...
                    Die Nutzung diverser Bereiche innerhalb der 5starUnity-Webseite setzt eine kostenfreie Anmeldung als Partner voraus. Ein erfolgreicher Anmeldeprozess bedarf u. a. der Zustimmung zu diesen AGB sowie der Bereitstellung benötigter Verifizierungsdateien. Mit der im Rahmen der Registrierung versendeten Bestätigungs-Mail sowie des Klicks auf den darin enthaltenen Aktivierungs-Link, kommt zwischen 5starUnity und dem Partner ein Vertrag über die Nutzung der 5starUnity-Webseiten zustande.
                            ...
                            <li>
                    <p>
                        Eine Anmeldung ist nur unbeschränkt geschäftsfähigen Personen erlaubt, welche insbesondere das 18. Lebensjahr vollendet haben und wahrheitsgemäße Angaben der abgefragten Daten vollständig übermitteln.
                    </p>
                            </li>
                            <li>
                    <p>
                    Bei der Anmeldung dürfen nur einzelne Personen als Inhaber eines Partnerskonto angegeben werden (d. h. keine Ehepaare oder Familien); Mehrfachregistrierungen (auch durch vorgeschobene Dritte) sind untersagt – eine Übertragbarkeit ist ausgeschlossen.
                    </p>
                            </li>
                            <li>
                    <p>
                    Alle Partner verpflichten sich, sämtliche angegebene Daten, welche sich nach der Anmeldung ändern, umgehend zu korrigieren und stets aktuell zu halten. Sollte eine selbstständige Abwandlung unmöglich sein, ist ein Änderungswunsch über die interne Mitteilungszentrale inkl. Begleitdokumente zu übermitteln.
                    </p>
                            </li>
                            <li>
                    <p>
                    	Der Partner ist für die Nutzung seines Accounts eigenständig verantwortlich und hat dafür Sorge zu tragen, dass das Passwort keinem Dritten zugänglich gemacht wird. Ferner trägt er die volle Verantwortung für alle Handlungen, welche über sein jeweiliges Profil auf den 5starUnity-Webseiten vorgenommen werden. Sollte der Partner eine unautorisierte oder missbräuchliche Nutzung seines Passworts oder seines Partnerskontos bemerken, ist er verpflichtet, dies 5starUnity unverzüglich mitzuteilen.
                    </p>
                            </li>
                            <li>
                    <p>
                        5starUnity behält sich das Recht vor, Profile, die mit Einmal-Emailadressen (auch unter Wegwerf-Emailadressen bekannt) registriert wurden, sowie Partnerkonten von nicht vollständig durchgeführten Anmeldungen nach einer angemessenen Zeit zu löschen.
                    </p>
                            </li>
                            <li>
                    <p>
                        Es besteht kein Anspruch auf Nutzung des und dem damit verbundenem Partnerkonto auf den 5starUnity-Webseiten. 5starUnity behält sich das Recht vor, selbst beim Vorliegen aller Voraussetzungen für eine Aufnahme,  Anmeldungsgesuche ohne Angabe von Gründen abzulehnen und bestätigt an dieser Stelle, dass alle bis zu diesem Zeitpunkt übermittelten Daten automatisch gelöscht werden.
                    </p>
                            </li>
                </ul>
                    <p>
                    ...
                    <ul>
                        ...
                        <li>
                            <p>
                            Auf den von 5starUnity zur Verfügung gestellten Webseiten bestehen technische Möglichkeiten, selbst Inhalte bzw. Kommentare zu veröffentlichen. Diese veröffentlichten Inhalte werden von 5starUnity grundsätzlich nicht geprüft und stellen nicht die Meinung von 5starUnity dar.
                            </p>
                        <li>
                            <p>
                            5starUnity ist ein freundlicher, sachlicher und fairer Umgangston wichtig. Deshalb behält sich der Vorstand bzw. die dafür zuständige Abteilung vor, Beiträge und Kommentare nicht zu veröffentlichen, zu löschen, zu bearbeiten, zu verschieben oder zu schließen, sofern ein intern definierter Verstoß vorliegt. 5starUnity wird Verhaltensregeln erstellen und diese im öffentlich zugänglichen Bereich hinterlegen.
                            </p>
                        </li>
                        <li>
                            <p>
                    ...
                    <ul>
                        <li>
                            <p>
                            Die Zahlungsabwicklung für sämtliche auf den 5starUnity-Webseiten vorgenommenen Spenden wird ausschließlich von auf der Plattform näher beschriebenen Zahlungsdienstleistern mit der Erlaubnis zum Betreiben von Finanztransfergeschäften durchgeführt.
                            </p>
                        </li>
                        <li>
                            <p>
                            Hinsichtlich der zur Verfügung gestellten Methoden (bspw: Kreditkarte, PayPal) gelten die jeweiligen Geschäftsbedingungen der einzelnen Anbieter, 5starUnity übernimmt keine Haftung für Vollständigkeit / Korrektheit der Angaben.
                            </p>
                        </li>  
                        <li> 
                            <p>
                            Entsprechend anfallende Kosten für etwaige Kursschwankungen bei Fremdwährungen sind stets abzuwägen und beim Zahlungsabwickler im Vorfeld zu erfragen.
                            </p>
                        </li>
                    </ul>
                    <strong>
                    ...
                    <ul>
                        <li>
                            <p>
                            Die Anmeldung als Partner, eine Teilnahme an der Lottery of Things (bei Verfügbarkeit von Talern) sowie der Erhalt von Preisen innerhalb der freigegebenen Länder ist kostenlos.
                            </p>
                        </li>
                        <li>
                            <p>
                        ...
                        <li>
                            <p>
                            Mitunter kann es vorkommen, dass Zahlungsabwickler für Spenden eine Kostennote oder Ähnliches in Rechnung stellen. Wir weisen darauf hin, dass diese Kosten vom jeweiligen Spender zu tragen sind; 5starUnity übernimmt nur die mit dem Abwickler eingegangenen Vertragsgebühren.
                            </p>
                        </li>
                    </ul>    
                    <strong>
                    ...
                    <ul>
                        <li>
                            <p>
                                Die Nutzung für alle 5starUnity-Webseiten wird auf unbestimmte Zeit geschlossen und kann von 5starUnity sowie dem Partner jederzeit mit sofortiger Wirkung beendet werden. Eine Beendigung des Verhältnisses geht mit der unwiderruflichen Löschung des Benutzerprofils einher und muss 5starUnity per E-Mail an Service@5starUnity.com mitgeteilt werden. Löschungen können bis zu 4 Wochen Zeit beanspruchen und sind in Textform (bzw. über die technologischen Funktionen im internen Bereich) zu erklären.
                            </p>
                        </li>
                        <li>
                            <p>
                            5starUnity ist berechtigt, Partner ohne Angabe von Gründen jederzeit von der Teilnahme an Foren, dem Kommentarsystem oder anderen angebotenen Bereichen, Dienstleistungen oder Systemen auszuschließen bzw. den Zugang teilweise oder in Gänze, zeitweise oder dauerhaft, zu beschränken.
                            </p>
                        </li>
                        <li>
                            <p>
                    ...
                    <ul>
                        <li>
                            <p>
                            	Alle Daten werden von 5starUnity ausschließlich zu den sich aus der Registrierung ergebenden Zwecken unter Beachtung der einschlägigen gesetzlichen Bestimmungen des Datenschutzes gespeichert und verarbeitet (siehe auch geltende Datenschutzerklärung).
                            </p>
                            </li>
                        <li>
                            <p>
                                Der Nutzer stimmt zu, dass einige personenbezogene Daten des Nutzers an eigene Unternehmen übermittelt werden dürfen. Diese Zustimmung kann der Nutzer jederzeit per E-Mail an Service@5starUnity.com widerrufen.
                            </p>
                        </li>
                        <li>
                            <p>
                    ...
                    <ul>
                        <li>
                            <p>
                                5starUnity versteht sich als Verein und erhält ausschließlich Spenden, welche nach geltender Satzung verwendet werden dürfen. Für alle Verkäufe, Veräußerungen oder sonstige Gegebenheiten, die ggf. im internen Bereich angeführt werden, ist ausschließlich das dort zu benennende Unternehmen zuständig.
                            </p>
                        </li>
                        <li>
                            <p>
                            Für die Nutzung der 5starUnity-Webseiten gelten diese AGB; im Allgemeinen verweist der Vorstand von 5starUnity auf § 306 BGB, welcher die Funktionen der salvatorischen Klausel erörtert und beschreibt.
                            </p>
                        </li>
                    </ul>    
                    <strong>
                    ...
                    <ul>
                        <li>
                    <p>
                    Es gilt das Recht der Bundesrepublik Deutschland unter Ausschluss des UN-Kaufrechts (CISG), sofern dies für 5starUnity von Relevanz ist. Zwingende Bestimmungen des Staates, in dem der Partner seinen gewöhnlichen Aufenthalt hat, bleiben unberührt.
                    </p>
                    </li>
                    <li>
                        <p>
                        Gerichtsstand für sämtliche Streitigkeiten aus und im Zusammenhang mit Verträgen ist, soweit gesetzlich zulässig, Stuttgart.
                        </p>
                    </li>
                    </ul>
                    <strong>
                    ...
                    <ul>
                        ...
                        <li>
                            <p>
                                Es wird ausdrücklich darauf hingewiesen, dass eine Nutzung der Plattformen, eine Partnerschaft in jedweder Form oder eine Teilnahme an der Lottery of Things kein Beitritt zum 5starUnity e.V. darstellt bzw. kein Beitritt ermöglicht.
                            </p>
                        </li>
                </ul>
                <br />
                <p>Stand: 21. Mai 2019</p>
            </div>
        </div>
    </div>
</div>
