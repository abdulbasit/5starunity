...
<div class="container">
    <div class="">
            ...
            <br />
            <p>
                    Eingetragen beim  Registration Department of Tartu County Court<br />
                    Register-Nummer: 14798622
...
<div class="container no-padding">
    ...
    <div class="row profile">
            ...
            <p>
                Sollte die Community Spenden über den Betreiber der beschriebenen Plattform übermitteln, finden gem. § 1 Abs. 4 keine Berührungspunkte mit selbigem statt – die Spenden werden zu 100% auf das Vereinskonto gebucht. Impressumsangaben für ausschließlich diesen Zweck sind: 
                {{-- <br /> --}}
            </p>
            <div class="col-xs-12 no-padding">
                <p>
            ...
            <p>
                5starUnity e.V. wird gerichtlich und außergerichtlich vertreten durch
            ...
            <div class="col-xs-12 no-padding">
                <p>
                    ...
                    c/o 5starUnity e.V.<br />
                    Karl-Schurz-Str. 16<br />
                    DE – 70190 Stuttgart <br />
                </p>
                <br />
                <p>
                    Vizepräsidentin und erste Stellvertreterin: Silvia Palka<br />
                    c/o 5starUnity e.V.<br />
                    Karl-Schurz-Str. 16<br />
                    DE – 70190 Stuttgart
                </p>
                <br />
                <p>
                    Vizepräsident und zweiter Stellvertreter: Alexander Müller<br />
                    c/o 5starUnity e.V.<br />
                    Karl-Schurz-Str. 16 <br />
                    DE – 70190 Stuttgart
            ...
            <div class="section-title text-left" style="float: left; width: 100%; margin-top: 40px; padding-bottom:0px">
                Inhaltliche Verantwortung
            </div>
            <p><b style="margin-bottom:20px">u.a. im Sinne § 55 Abs. 2 RStV </b></p><br />
            <p>
                Für alle von 5starUnity e.V. erhaltenen Spenden, bzw. alle damit zusammenhängenden Darstellungen, Empfangsbestätigungen usw. ist             
            </p>
            <div class="col-xs-12 no-padding">
                <p>
                    Präsident Dirk Marras<br />
