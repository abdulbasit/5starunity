    ...
    <section id="horizontal-form-layouts">
        ...
        <div class="col-md-12">
            ...
            <div class="card-content collpase show">
                <div class="card-body">
                <form class="form form-horizontal" method="post" action="/admin/promotions/save" enctype="multipart/form-data">
                    @csrf
                    <div class="form-body">
                        ...
                        <div class="col-md-9">
                            <select name="category" id="category" class="form-control">
                                ...
                                @foreach($category as $promoCat)
                                    <option value="{{$promoCat->id}}">{{$promoCat->name}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div> 
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input required="required" type="text" id="name" class="form-control" placeholder="Promotion Title"  name="name">
                        </div>
                    </div> 
                    <div class="form-group row">
                        <label class="col-md-3 label-control" for="amount"> Orignal Price</label>
                        <div class="col-md-9">
                            <input required="required" type="text" id="amount" class="form-control" placeholder="Promotion Amount"  name="amount">
                        </div>
                    </div> 
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="input-group col-md-9">
                            ...
                            <input required="required" type='text' class="form-control pickadate-select-year" placeholder="Select End Date" name="end_date" id="end_date" />
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-md-3 label-control" for="siteurl"> Website Url</label>
                        <div class="col-md-9">
                            <input required="required" type="text" id="siteurl" class="form-control" placeholder="http://example.com"  name="siteurl">
                        </div>
                    </div> 
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <textarea name="desc" id="desc" name="desc" class="form-control" rows="10"></textarea>
                        </div>
                    </div>   
                    <div class="form-group row">
