                        ...
                        <form class="form form-horizontal" method="post" action="/admin/product/update/{{$productInfo->id}}" enctype="multipart/form-data">
                          ...
                          <div class="form-body">
                            ...
                            <div class="form-group row">
                              ...
                              <div class="col-md-9">
                                <input type="text" id="name" class="form-control" value="{{$productInfo->pro_name}}" placeholder="Complete Name"  name="name">
                              </div>
                            </div>
                            <div class="form-group row">
                              <label class="col-md-3 label-control" for="projectinput3">Price</label>
                              <div class="col-md-9">
                                <input type="text" id="price" class="form-control" value="{{$productInfo->pro_price}}" placeholder="Product Price" name="price">
                              </div>
                            </div>
                            <div class="form-group row">
