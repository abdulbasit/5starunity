          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h4 class="card-title">Admin Listing
                <a href="/admin/new-admin" class="btn btn-social pull-right navBtn">
                                ...
                                <div class="col-sm-3 col-6">
                                    <div class="btn-group mr-1 mb-1">
                                        ...
                                        <div class="dropdown-menu arrow " id="options">
                                            <a class="dropdown-item" href="{{ route('admin.admin-edit',$admin->id) }}"><i class="ft-edit green"></i> Edit </a>
                                            <a onclick="deleteCategory({{$admin->id}})" id="delete"  class="dropdown-item" href="#"><i class="ft-slash red"></i> Delete</a>
                                        </div>
