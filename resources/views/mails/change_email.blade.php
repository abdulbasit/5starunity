                              ...
                              <tbody>
                                ...
                                <tr>
                                  <td align="center"> <span style="color:#48545d;font-size:14px;line-height:24px;">
                                    <span style="text-align:left">Hello <b>{{$email->recevier_name}}</b>,<br /></span>
                                    You have requested email change. Your new email address will be  <b>"{{$email->new_email}}"</b>.
                                    If you are agree please click below link.<br />
                                    In order to start using your 5Starunity account, you need to confirm your email addres.
                                    </span>
                                  </td>
                                </tr>
                                <tr>
