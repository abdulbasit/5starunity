                              ...
                              <tbody>
                                ...
                                <tr>
                                  <td align="center"> <span style="color:#48545d;font-size:14px;line-height:24px;">
                                    <span style="text-align:left">Hello  <b>{{$email->name}}</b>,<br /></span>
                                        You have updated your Profile. We have holded your account for some security reasons, 
                                        Let us verify your Profile Changes. Once it verify your account will be reactivated.
                                ...
                                <tr>
                                  <td align="center">
                                    <p style="color:#a2a2a2; font-size:12px; line-height:17px; font-style:italic;">If you did not chagne your profile contact us admin@5starunity.com.</p>
                                  </td>
                                </tr>
                              </tbody>
                            </table>
